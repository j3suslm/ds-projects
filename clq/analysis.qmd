...
![](images/header.png){width=52% .lightbox fig-align="left"}
...
<iframe 
    ...
    style="width:100%; height:680px; border:none; transform:scale(1.); transform-origin:0 0;"
    data-external="1" 
    title="Contact Form">
</iframe>
```

::: {style="color: #1F7A8C; font-size: 22px; font-style: bold;"}
Jesus L. Monroy
:::
...
::: {style="color: #6f7271; font-size: 14px; width: 60%; text-align: justify;"}
