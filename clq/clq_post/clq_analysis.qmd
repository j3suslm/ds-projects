---
title: "Crime Localization in Mexico 2025"
subtitle: "An Application of Location Quotients to High-Impact Offenses"
date: "2025-12-08"
...
abstract: |
    ...
    <br>
    In contrast, the Location Quotient provides a robust analytical tool for determining whether a specific geographic area experiences a disproportionate share of a given crime type relative to a larger reference area, thereby highlighting true criminal hotspots.
format:
  html:
    code-copy: false
...
![](map.png){#fig-crimes width=60% .lightbox fig-align="left"}
...
- **Key Findings**: Significant spatial concentration (LQ > 1.0) will be revealed.
...
Required Data: The number of victims of homicide disaggregated by municipality and the national total for the study period (*Jan-Oct 2025*).
...
# filter municipalities with more than 10,000 people
